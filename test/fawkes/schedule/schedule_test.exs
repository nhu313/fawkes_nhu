defmodule Fawkes.ScheduleTest do
  ...
  describe "speakers" do
    ...
    @valid_attrs %{company: "some company", description: "some description", first_name: "some first_name", github: "some github", image_url: "some image_url", last_name: "some last_name", slug: "some slug", twitter: "some twitter"}
